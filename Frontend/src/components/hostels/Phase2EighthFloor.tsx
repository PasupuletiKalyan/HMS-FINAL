...
const Phase2EighthFloorPlan: React.FC<FloorPlanProps> = ({ 
  ...
  const elements = [
    ...
    { id: 'Balcony_Top_L', x: 10 + roomW + hGap, y: 10, width: roomW * 1.5, height: roomH, type: 'common', label: 'Balcony' },
    { id: '819', x: 10 + roomW + hGap + roomW * 1.5 + hGap, y: 10, width: roomW, height: roomH, type: 'room' },
    ...
    { id: 'Balcony_Top_R', x: 10 + 17 * (roomW + hGap) + roomW * 1.5, y: 10, width: roomW * 2 + hGap, height: roomH, type: 'common', label: 'Balcony' },
    ...
    // Row 2 (middle row)
    { id: 'Stairs_Top_L', x: 10 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'Stairs' },
    { id: '825', x: 10 + hGap + roomW * 1.5 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '824', x: 10 + 2 * hGap + roomW * 2.5, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '823', x: 10 + 3 * hGap + roomW * 3.5, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: 'WS_Top_L', x: 10 + 4 * hGap + roomW * 4.5, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'WS' },
    { id: 'Stairs_Top_M1', x: 10 + 5 * hGap + roomW * 6, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'Stairs' },
    { id: 'Lifts_Top_M1', x: 10 + 6 * hGap + roomW * 7.5, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'Lifts' },
    { id: '844', x: 10 + 7 * hGap + roomW * 9, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: 'Balcony_Mid', x: 10 + 8 * hGap + roomW * 10, y: 10 + 2 * (roomH + vGap), width: roomW * 2 + hGap, height: roomH, type: 'common', label: 'Balcony' },
    { id: '843', x: 10 + 10 * hGap + roomW * 12 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: 'WS_Top_R', x: 10 + 11 * hGap + roomW * 13 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'WS' },
    { id: 'Stairs_Top_M2', x: 10 + 12 * hGap + roomW * 14.5 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'Stairs' },
    { id: 'Lifts_Top_R', x: 10 + 13 * hGap + roomW * 16 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'Lifts' },
    { id: '842', x: 10 + 14 * hGap + roomW * 17.5 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    ...
    { id: '811', x: 10, y: 10 + 5 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '810', x: 10, y: 10 + 6 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    ...
    { id: '809', x: 10, y: 10 + 8 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '808', x: 10, y: 10 + 9 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '807', x: 10, y: 10 + 10 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    
    // Gap in the layout
    { id: '805', x: 10, y: 10 + 12 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: 'Lifts_Left', x: 10, y: 10 + 13 * (roomH + vGap), width: roomW, height: roomH * 1.5, type: 'common', label: 'Lifts' },
    ...
    { id: '803', x: 10, y: 10 + 16 * (roomH + vGap) + roomH * 0.5, width: roomW, height: roomH, type: 'room' },
    { id: '802', x: 10, y: 10 + 17 * (roomH + vGap) + roomH * 0.5, width: roomW, height: roomH, type: 'room' },
    { id: 'Stairs_Left', x: 10, y: 10 + 18 * (roomH + vGap) + roomH * 0.5, width: roomW, height: roomH * 1.5, type: 'common', label: 'Stairs' },
    { id: '801', x: 10, y: 10 + 19 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },

    // --- Second Vertical Section ---
    { id: '815', x: 10 + 2 * (roomW + hGap), y: 10 + 6 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '816', x: 10 + 2 * (roomW + hGap), y: 10 + 8 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '817', x: 10 + 2 * (roomW + hGap), y: 10 + 9 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '818', x: 10 + 2 * (roomW + hGap), y: 10 + 10 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    
    // Special rooms with adjustments
    { id: '804', x: 10 + 2 * (roomW + hGap), y: 10 + 13 * (roomH + vGap), width: roomW, height: roomH * 1.5, type: 'room' },
    { id: '806', x: 10 + 2 * (roomW + hGap), y: 10 + 19 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },
