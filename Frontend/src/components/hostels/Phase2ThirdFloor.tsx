...
const Phase2ThirdFloorPlan: React.FC<FloorPlanProps> = ({ 
  ...
  const topRowY = getY(600, 19); // Top row Y
  const bottomRowY = getY(600, 18); // Bottom row Y
  ...
  const elements = [
    ...
    { id: '341', x:1160 + 4*(roomW + hGap), y: getY(550, 15), width: roomW, height: roomH, type: 'room' }, // Use calculated start X
