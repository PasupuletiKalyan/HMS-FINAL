...
const Phase2TenthFloorPlan: React.FC<FloorPlanProps> = ({ 
  ...
  const elements = [
    ...
    { id: '1017', x: 10 + 3*(roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1018', x: 10 + 4 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1019', x: 10 + 5 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1020', x: 10 + 6 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1024', x: 10 + 7 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1025', x: 10 + 8 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1026', x: 10 + 9 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1027', x: 10 + 10* (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1028', x: 10 + 11 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1029', x: 10 + 12 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1030', x: 10 + 13 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1031', x: 10 + 14 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1032', x: 10 + 15 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1033', x: 10 + 16 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1034', x: 10 + 17 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1035', x: 10 + 18 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1036', x: 10 + 22 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1037', x: 10 + 23 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1038', x: 10 + 24 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '1039', x: 10 + 25 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    ...
    { id: 'Stairs_Top_L', x: 60 + roomW + hGap, y: 10 + 3 * (roomH + vGap), width: roomW, height: roomH, type: 'common', label: 'Stairs' },
    { id: '1023', x: 10 + 3*(roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '1022', x: 10 + 4 * (roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '1021', x: 10 + 5 * (roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: 'WS_Top_L', x: 10 + 6 * (roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 2.5, height: roomH, type: 'common', label: 'WS' },
    { id: 'Stairs_Top_M1', x: 10 + 10 * (roomW + hGap), y: 10 + 2 * (roomH + vGap), width: 40, height: roomH, type: 'common', label: 'Stairs' },
    { id: 'Lifts_Top_M1', x: 10 + 7 * (roomW + hGap) + 4.5 * roomW + 3 * hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'Lifts' },
    { id: '1042', x: 10 + 13 * (roomW + hGap), y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '1043', x: 10 + 16 * (roomW + hGap), y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: 'WS_Top_R', x: 10 + 17 * (roomW + hGap) + hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 2.5, height: roomH, type: 'common', label: 'WS' },
    { id: 'Stairs_Top_M2', x: 10 + 19 * (roomW + hGap) + roomW, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'common', label: 'Stairs' },
    { id: 'Lifts_Top_R', x: 10 + 18 * (roomW + hGap) + roomW * 3 + 3 * hGap, y: 10 + 2 * (roomH + vGap), width: roomW * 1.5, height: roomH, type: 'common', label: 'Lifts' },
    { id: '1040', x: 10 + 21 * (roomW + hGap) + roomW * 4.5 + 4 * hGap, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },

    // Left Vertical Section
    { id: '1010', x: 10, y: 10 + 4 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    ...
    { id: '1012A', x: 105, y: 10 + 6 * (roomH + vGap) + roomH/2, width: roomW, height: roomH, type: 'room' },
    { id: '1014', x: 105, y: 10 + 7 * (roomH + vGap) + roomH/2, width: roomW, height: roomH, type: 'room' },
    
    
    { id: '1008', x: 10, y: 10 + 8 * (roomH + vGap) + roomH/2, width: roomW, height: roomH, type: 'room' },
    { id: '1007', x: 10, y: 10 + 9 * (roomH + vGap) + roomH/2, width: roomW, height: roomH, type: 'room' },
    
    // Gap in the layout
    { id: 'Lifts_Left', x: 105, y: 10 + 14 * (roomH + vGap), width: roomW, height: roomH * 1.5, type: 'common', label: 'Lifts' },
    { id: '1005', x: 10, y: 10 + 12 * (roomH + vGap) + roomH * 0.5, width: roomW, height: roomH, type: 'room' },
    
    
    { id: 'Stairs_Left', x: 105, y: 10 + 15 * (roomH + vGap) + roomH * 0.5, width: roomW, height: roomH * 1.5, type: 'common', label: 'Stairs' },
    { id: '1004', x: 10, y: 10 + 13 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },
    { id: '1003', x: 10, y: 10 + 14 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },
    { id: '1002', x: 10, y: 10 + 15 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },
    { id: '1001', x: 10, y: 10 + 16 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },

    // Second Vertical Section
    { id: '1015', x: 10 + 2 * (roomW + hGap), y: 10 + 8 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },
    { id: '1016', x: 10 + 2 * (roomW + hGap), y: 10 + 9 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },
    { id: '1006', x: 10 + 2 * (roomW + hGap), y: 10 + 16 * (roomH + vGap) + roomH, width: roomW, height: roomH, type: 'room' },
