...
const Phase2SeventhFloorPlan: React.FC<FloorPlanProps> = ({ 
  ...
  const elements = [
    ...
    { id: '716', x: 10 + 2 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '721', x: 10 + 3 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '722', x: 10 + 4 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '723', x: 10 + 5 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '724', x: 10 + 6 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '728', x: 10 + 7 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '729', x: 10 + 8 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '730', x: 10 + 9 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '731', x: 10 + 10 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '732', x: 10 + 11 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '733', x: 10 + 12 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '734', x: 10 + 13 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '735', x: 10 + 14 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '736', x: 10 + 15 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '737', x: 10 + 16 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '738', x: 10 + 17 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '739', x: 10 + 18 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '740', x: 10 + 19 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '741', x: 10 + 20 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '742', x: 10 + 21 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '743', x: 10 + 22 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '744', x: 10 + 23 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    { id: '745', x: 10 + 24 * (roomW + hGap), y: 10, width: roomW, height: roomH, type: 'room' },
    ...
    { id: '727', x: 10 + (roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: '726', x: 10 + 2 * (roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: '725', x: 10 + 3 * (roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: 'WS_Top_L', x: 10 + 4 * (roomW + hGap) + roomW * 1.5 + hGap, y: 10 + 2 * roomH + vGap, width: roomW * 1.5, height: roomH, type: 'common', label: 'WS' },
    { id: 'Stairs_Top_M', x: 10 + 4 * (roomW + hGap) + 3 * roomW + 2 * hGap, y: 10 + 2 * roomH + vGap, width: roomW * 1.5, height: roomH, type: 'common', label: 'Stairs' },
    { id: 'Lifts_Top_M', x: 10 + 4 * (roomW + hGap) + 4.5 * roomW + 3 * hGap, y: 10 + 2 * roomH + vGap, width: roomW * 1.5, height: roomH, type: 'common', label: 'Lifts' },
    { id: '751', x: 10 + 4 * (roomW + hGap) + 6 * roomW + 4 * hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: '750', x: 10 + 5 * (roomW + hGap) + 6 * roomW + 4 * hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: '749', x: 10 + 6 * (roomW + hGap) + 6 * roomW + 4 * hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: '748', x: 10 + 7 * (roomW + hGap) + 6 * roomW + 4 * hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: '747', x: 10 + 8 * (roomW + hGap) + 6 * roomW + 4 * hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },
    { id: 'WS_Top_R', x: 10 + 9 * (roomW + hGap) + 6 * roomW + 4 * hGap, y: 10 + 2 * roomH + vGap, width: roomW * 1.5, height: roomH, type: 'common', label: 'WS' },
    { id: 'Stairs_Top_R', x: 10 + 9 * (roomW + hGap) + 7.5 * roomW + 5 * hGap, y: 10 + 2 * roomH + vGap, width: roomW * 1.5, height: roomH, type: 'common', label: 'Stairs' },
    { id: 'Lifts_Top_R', x: 10 + 9 * (roomW + hGap) + 9 * roomW + 6 * hGap, y: 10 + 2 * roomH + vGap, width: roomW * 1.5, height: roomH, type: 'common', label: 'Lifts' },
    { id: '746', x: 10 + 9 * (roomW + hGap) + 10.5 * roomW + 7 * hGap, y: 10 + 2 * roomH + vGap, width: roomW, height: roomH, type: 'room' },

    // --- Left Vertical Section ---
    { id: '712A', x: 10, y: 10 + 2 * (roomH + vGap), width: roomW, height: roomH, type: 'room' }, // Aligns with row 2 start
    { id: 'WS_Left_1', x: 10, y: 10 + 3 * (roomH + vGap), width: roomW, height: roomH, type: 'common', label: 'WS' },
    ...
    { id: 'corridor_left', x: 10 + roomW + hGap/2, y: 10 + 3 * (roomH + vGap), width: 15, height: 8 * (roomH + vGap), type: 'corridor' },
    
    { id: '709', x: 10, y: 10 + 8 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '708', x: 10, y: 10 + 9 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '707', x: 10, y: 10 + 10 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    
    // Gap in the layout
    { id: 'Lifts_Left', x: 10, y: 10 + 12 * (roomH + vGap), width: roomW, height: roomH * 1.5, type: 'common', label: 'Lifts' },
    { id: '705', x: 10, y: 10 + 13 * (roomH + vGap) + roomH * 0.5, width: roomW, height: roomH, type: 'room' },
    { id: 'Stairs_Left', x: 10, y: 10 + 14 * (roomH + vGap) + roomH * 0.5, width: roomW, height: roomH * 1.5, type: 'common', label: 'Stairs' },
    
    // Corridor - vertical (left bottom)
    { id: 'corridor_left_bottom', x: 10 + roomW + hGap/2, y: 10 + 15 * (roomH + vGap), width: 15, height: 7 * (roomH + vGap), type: 'corridor' },
    
    { id: '704', x: 10, y: 10 + 17 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '703', x: 10, y: 10 + 18 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: 'WS_Left_2', x: 10, y: 10 + 19 * (roomH + vGap), width: roomW, height: roomH, type: 'common', label: 'WS' },
    { id: '702', x: 10, y: 10 + 20 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '701', x: 10, y: 10 + 21 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },

    // --- Second Vertical Section ---
    { id: '717', x: 10 + 2 * (roomW + hGap), y: 10 + 6 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '718', x: 10 + 2 * (roomW + hGap), y: 10 + 8 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '719', x: 10 + 2 * (roomW + hGap), y: 10 + 9 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    { id: '720', x: 10 + 2 * (roomW + hGap), y: 10 + 10 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    
    // Bottom section
    { id: '706', x: 10 + 2 * (roomW + hGap), y: 10 + 21 * (roomH + vGap), width: roomW, height: roomH, type: 'room' },
    ...
    { id: 'Corridor_Left_Bottom', x: 10 + roomW + hGap/2 + 7.5, y: 10 + 19 * (roomH + vGap), label: 'Corridor', type: 'label', rotation: 90 }
  ];
